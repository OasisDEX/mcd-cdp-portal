export default {
  ...
  borrow_landing: {
    ...
    questions: {
      ...
      answer1:
        'Currently, Oasis Borrow supports ETH, BAT, USDC, WBTC and {0}. There are plans for more types of collateral, and in some cases there can be multiple versions of the same collateral type with different risk parameters. You can read the Collateral On-boarding Guide for the Maker Protocol to find out more.',
      answer1_link1_url: '/borrow/markets',
      answer1_link1_text: 'many others',
