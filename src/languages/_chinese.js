export default {
  ...
  "landing_page": {
    ...
    "section2_p": "Oasis 是由 Maker 开发，基于以太坊创建、通过形式化验证和安全审计的智能合约，是去中心化金融领域的领导者。",
    "section3_title": "完全无门槛",
    "section3_p": "Oasis 是完全去中心化、无中心化托管的平台，通过以太坊钱包即可访问，资产永远掌握在用户自己手里。",
    "questions_title": "常见问题",
    "question1": "Oasis 是什么?",
    "answer1": "Oasis 是运行在以太坊区块链上的去中心化应用。任何人都可以在 Oasis 上交易数字资产、抵押借 Dai 并且存 Dai 生息。",
    "question2": "Dai 是什么?",
    "answer2": "Dai 是全球第一个无偏见的去中心化稳定币，其价格和美元保持软锚定。了解 Dai：{0}",
    "answer2_link1_url": "https://makerdao.com/dai/",
    "answer2_link1_text": "更多内容",
    "question3": "我需要注册账户吗?",
    "answer3": "使用 Oasis，你不用注册账户，只需要通过以太坊钱包连接。Oasis 支持以下以太坊钱包: {0}, {1} 等。",
    ...
    "question4": "借贷和存款功能何时上线？",
    "answer4": "借贷和存款功能将在多抵押 Dai 发布时上线。查看多抵押 Dai 进展: {0}.",
    "answer4_link1_url": "https://makerdao.com/roadmap/",
    "answer4_link1_text": "更多内容",
    "question5": "Oasis 安全吗?",
    "answer5": "Oasis 具备最高的安全标准，并且经过日常的审计和形式化验证。此外, Oasis 是 {0} 协议，任何人都可以测试和审计。",
    "answer5_link1_url": "https://github.com/OasisDEX",
    "answer5_link1_text": "开源",
    "question6": "在 Oasis 上交易需要付手续费吗？",
    "answer6": "Oasis 协议本身是完全免费的。在使用过程中，你仅需要支付以太坊矿工费。",
    "question7": "如何联系 Oasis 团队?",
    "answer7": "你可以通过 {0} 联系 Oasis 团队.",
    "answer7_link1_url": "https://chat.makerdao.com",
    "answer7_link1_text": "Maker Chat",
    "question8": "我可以用银行卡在 Oasis 上购买比特币或者以太坊吗？",
    "answer8": "你无法在 Oasis 用银行卡购买加密资产，你可以用 Dai 购买以太坊和其他资产。",
    "read_only": "只读",
  ...
  "action_sidebar": {
    ...
    "cannot_payback_more_than_owed": "Dai 余额不足",
